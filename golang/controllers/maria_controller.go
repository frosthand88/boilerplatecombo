...
type MariaController struct {
	service *service.MariaService
}

func NewMariaController(service *service.MariaService) *MariaController {
	return &MariaController{service: service}
}
...
// @Router /maria/researchers [get]
func (c *MariaController) GetResearchers(ctx *gin.Context) {
