...
type MssqlController struct {
	service *service.MssqlService
}

func NewMssqlController(service *service.MssqlService) *MssqlController {
	return &MssqlController{service: service}
}
...
// @Router /mssql/researchers [get]
func (c *MssqlController) GetResearchers(ctx *gin.Context) {
