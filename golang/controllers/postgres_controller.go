...
func NewPostgresController(service *service.PostgresService) *PostgresController {
	return &PostgresController{service: service}
}
...
// @Router /postgres/researchers [get]
func (c *PostgresController) GetResearchers(ctx *gin.Context) {
