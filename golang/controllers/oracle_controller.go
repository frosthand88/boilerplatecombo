...
func NewOracleController(service *service.OracleService) *OracleController {
	return &OracleController{service: service}
}
...
// @Router /oracle/researchers [get]
func (c *OracleController) GetResearchers(ctx *gin.Context) {
