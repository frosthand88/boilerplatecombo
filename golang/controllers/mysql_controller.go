...
func NewMysqlController(service *service.MysqlService) *MysqlController {
	return &MysqlController{service: service}
}
...
// @Router /mysql/researchers [get]
func (c *MysqlController) GetResearchers(ctx *gin.Context) {
