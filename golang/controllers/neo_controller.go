...
type NeoController struct {
	service *service.NeoService
}

func NewNeoController(service *service.NeoService) *NeoController {
	return &NeoController{service: service}
}
...
// @Router /neo/researchers [get]
func (c *NeoController) GetResearchers(ctx *gin.Context) {
