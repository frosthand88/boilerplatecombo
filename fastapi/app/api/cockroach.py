...
from app.db.database import get_cockroach_session
from app.db.models.researcher_cokcroach import Researcher

router = APIRouter(prefix="/cockroach")
...
async def get_researchers(
    ...
    session: AsyncSession = Depends(get_cockroach_session),
):
