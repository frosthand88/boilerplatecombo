...
import com.boilerplatecombo.service.MariaResearcherService;
...
@RestController
@RequestMapping("/maria/researcher")
public class MariaResearcherController {

    private MariaResearcherService service;

    public MariaResearcherController(@Lazy MariaResearcherService researcherService) {
