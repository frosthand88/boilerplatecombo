...
import com.boilerplatecombo.service.NeoResearcherService;
...
@RestController
@RequestMapping("/neo/researcher")
public class NeoResearcherController {

    private NeoResearcherService service;

    public NeoResearcherController(@Lazy NeoResearcherService researcherService) {
