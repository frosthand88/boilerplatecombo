...
import com.boilerplatecombo.service.DuckResearcherService;
...
@RestController
@RequestMapping("/duck/researcher")
public class DuckResearcherController {

    private DuckResearcherService service;

    public DuckResearcherController(@Lazy DuckResearcherService researcherService) {
