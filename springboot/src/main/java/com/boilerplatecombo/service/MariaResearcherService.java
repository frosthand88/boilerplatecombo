...
import com.boilerplatecombo.repo.maria.MariaResearcherRepository;
...
@Service
public class MariaResearcherService {

    //@Autowired
    private MariaResearcherRepository repository;

    @PersistenceContext(unitName = "mariaEntityManagerFactory")
    private EntityManager entityManager;

    public MariaResearcherService(@Lazy MariaResearcherRepository repo) {
