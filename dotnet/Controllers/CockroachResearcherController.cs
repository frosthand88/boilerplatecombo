...
[ApiController]
[Route("cokcroach/researcher")]
public class CockroachResearcherController : ControllerBase
{
    private readonly CockroachResearcherService _service;

    public CockroachResearcherController(CockroachResearcherService service)
    {
        _service = service;
    }
