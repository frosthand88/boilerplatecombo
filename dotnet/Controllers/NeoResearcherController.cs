...
[ApiController]
[Route("neo/researcher")]
public class NeoResearcherController : ControllerBase
{
    private readonly NeoResearcherService _service;

    public NeoResearcherController(NeoResearcherService service)
    {
        _service = service;
    }
