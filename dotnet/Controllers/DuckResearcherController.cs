...
[ApiController]
[Route("duck/researcher")]
public class DuckResearcherController : ControllerBase
{
    private readonly DuckResearcherService _service;

    public DuckResearcherController(DuckResearcherService service)
    {
        _service = service;
    }
