...
[ApiController]
[Route("dynamo/researcher")]
public class DynamoResearcherController : ControllerBase
{
    private readonly DynamoResearcherService _service;

    public DynamoResearcherController(DynamoResearcherService service)
    {
        _service = service;
    }
