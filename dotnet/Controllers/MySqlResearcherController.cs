...
[ApiController]
[Route("mysql/researcher")]
public class MySqlResearcherController : ControllerBase
{
    private readonly MySqlResearcherService _service;

    public MySqlResearcherController(MySqlResearcherService service)
    {
        _service = service;
    }
