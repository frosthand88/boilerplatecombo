...
[ApiController]
[Route("maria/researcher")]
public class MariaResearcherController : ControllerBase
{
    private readonly MariaResearcherService _service;

    public MariaResearcherController(MariaResearcherService service)
    {
        _service = service;
    }
