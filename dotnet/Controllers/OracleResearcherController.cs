...
[ApiController]
[Route("oracle/researcher")]
public class OracleResearcherController : ControllerBase
{
    private readonly OracleResearcherService _service;

    public OracleResearcherController(OracleResearcherService service)
    {
        _service = service;
    }
