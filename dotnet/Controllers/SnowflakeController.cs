...
[ApiController]
[Route("snowflake/researcher")]
public class SnowflakeResearcherController : ControllerBase
{
    private readonly SnowflakeResearcherService _service;

    public SnowflakeResearcherController(SnowflakeResearcherService service)
    {
        _service = service;
    }
