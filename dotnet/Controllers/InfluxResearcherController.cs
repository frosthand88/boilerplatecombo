...
[ApiController]
[Route("influx/researcher")]
public class InfluxResearcherController : ControllerBase
{
    private readonly InfluxResearcherService _service;

    public InfluxResearcherController(InfluxResearcherService service)
    {
        _service = service;
    }
